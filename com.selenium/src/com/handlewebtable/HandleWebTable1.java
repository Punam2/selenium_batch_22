...
public class HandleWebTable1 {
	...
	public static void main(String[] args)
	{
		...
		String xpath="]";
		HandleWebTable1.WebTable(driver, row, col, before_xpath, after_xpath, xpath);
	}
	public static void WebTable(WebDriver driver,int row,int col,String before,String after,String path)
	{
		for (int i=2;i<=row;i++)
		{
			for(int j=1;j<=col;j++)
			{
				...
				String text=driver.findElement(By.xpath(before+i+after+j+path)).getText();
